...
type MySQLConfig struct {
	...
	ReadTimeout      common.DurationString `json:"readTimeout,omitempty" yaml:"readTimeout,omitempty"`
	WriteTimeout     common.DurationString `json:"writeTimeout,omitempty" yaml:"writeTimeout,omitempty"`
}
